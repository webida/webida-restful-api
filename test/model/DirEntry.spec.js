...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebidaRestfulApi.DirEntry();
  });
  ...
  describe('DirEntry', function() {
    it('should create an instance of DirEntry', function() {
      // uncomment below and update the code to test DirEntry
      //var instane = new WebidaRestfulApi.DirEntry();
      //expect(instance).to.be.a(WebidaRestfulApi.DirEntry);
    });
