...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebidaRestfulApi.SessionApi();
  });
  ...
  describe('SessionApi', function() {
    ...
    describe('findSessions', function() {
      it('should call findSessions successfully', function(done) {
        //uncomment below and update the code to test findSessions
        //instance.findSessions(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
