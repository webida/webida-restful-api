...
(function(root, factory) {
   ...
   * @param background {Array.<String>} true when this process is spawned by asynchronous exec request or some other ways to spawn processes in server. fasle when this process is spawened with plain, synchronous execution request. 
   */
   ...
   * @member {Array.<String>} background
   */
